...
export const CompanyBanner = () => {
  ...
  const usersCount = useCompanyStore((state: any) => state.usersCount);
  return (
    <Container>
      <div className='content-wrapper-content'>
        ...
        <p className='content-text'>InvenTrack keeps you informed.</p>
        <ContentCards>
          <CompanyCard
            title='Currency'
            value={companyData.companies?.currency}
          />
          <CompanyCard title='Users' value={usersCount} />
        </ContentCards>
      </div>
